...
.\packer.exe build '-var-file=Win2019\vars.json' -var "vsphere-server=$Vcenters" -var "vsphere-user=$vsphere_user" -var "vsphere-password=$vsphere_password" -var "vm-name=$vmname" 'Win2019\windows2019.json'